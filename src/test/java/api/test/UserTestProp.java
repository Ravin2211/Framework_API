...
public class UserTestProp {
    ...
    public void testPostUser(){
        ...
        Response res = UserEndpointsProp.createUser(userpayload); //calling the Usermodendpoint class where the impementation happens
        res.then().log().all();
    ...
    public void testUpdateUser(){
        ...
        Response res =UserEndpointsProp.updateUser(this.userpayload.getUsername(),userpayload); //calling the Usermodendpoint class where the impementation happens
        res.then().log().body().statusCode(200);   //Same as assertion statement

        //Assert.assertEquals(res.getStatusCode(),200);

        //checking response after modification
        Response resAfterUpdate = UserEndpointsProp.readUser(this.userpayload.getUsername());
    ...
    public void testDeleteUser(){
        ...
        Response res= UserEndpointsProp.deleteUser(this.userpayload.getUsername());
        res.then().log().all();
        Assert.assertEquals(res.getStatusCode(),200);
